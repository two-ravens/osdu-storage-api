...
func (s *Health) HealthMessage(ctx context.Context, dataPartitionID string, opts ...operations.Option) (*operations.HealthMessageResponse, error) {
	...
	request := operations.HealthMessageRequest{
	...
	res := &operations.HealthMessageResponse{
